    ...
    return (
      <View>
        ...
        <View style={ styles.deviceStyle}>
          ...
          <View style={{marginRight:20, marginTop:7}}><BlueButton style={styles.blueButton}>ACTIVATE</BlueButton></View>
        </View>
        ...
        <View style={ styles.deviceStyle}>
          ...
          <View style={{marginRight:20, marginTop:7}}><BlueButton>ACTIVATE</BlueButton></View>
        </View>
